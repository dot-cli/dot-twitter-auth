// Forked from https://github.com/watson/twitter-pin/blob/master/index.js
// since it's missing 'oob' when instantiating new OAuth(...)
"use strict";

var OAuth = require("oauth").OAuth;

var TwitterPin = (module.exports = function (consumerKey, consumerSecret) {
  if (!(this instanceof TwitterPin))
    return new TwitterPin(consumerKey, consumerSecret);
...
TwitterPin.prototype.authorize = function (token, pin, cb) {
